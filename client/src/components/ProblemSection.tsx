      ...
      >
        ...
        <div className="flex-1" style={{ paddingRight: '40px' }}>
          ...
          >
            ...
            <br />
            <span style={{ color: '#78A287' }}>We think it can work better.</span>
          </h2>
        ...
        >
          <p>
            Assessment for accreditation follows a familiar pattern across systems like
            AACSB and ABET: reviewing student work, applying evaluation criteria, and
            documenting evidence of learning outcomes.
          </p>
          <p style={{ marginTop: '24px' }}>
            This work sits at the intersection of faculty workload, institutional
            accountability, and continuous improvement — yet remains one of the least
            well-supported workflows in higher education.
          </p>
          <p style={{ marginTop: '24px' }}>
            We&rsquo;re starting by looking at a few of the most challenging parts:
          </p>
          <ul style={{ marginTop: '12px', paddingLeft: '0', listStyle: 'none' }}>
            {[
              ...
              >
                <span style={{ marginRight: '10px', flexShrink: 0 }}>&bull;</span>
                <span>{item}</span>
              </li>
            ))}
          </ul>
          <p style={{ marginTop: '24px' }}>
            We are exploring how this process could be redesigned in an AI-native way —
            reducing manual effort while strengthening the evidence behind assessment
            with faculty remaining fully in control.
          </p>
        </div>
      </div>
