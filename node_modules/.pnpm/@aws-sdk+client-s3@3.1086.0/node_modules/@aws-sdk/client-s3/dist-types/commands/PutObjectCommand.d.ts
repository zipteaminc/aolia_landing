...
declare const PutObjectCommand_base: {
    new (input: PutObjectCommandInput): import("@smithy/core/client").CommandImpl<PutObjectCommandInput, PutObjectCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutObjectCommandInput): import("@smithy/core/client").CommandImpl<PutObjectCommandInput, PutObjectCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
