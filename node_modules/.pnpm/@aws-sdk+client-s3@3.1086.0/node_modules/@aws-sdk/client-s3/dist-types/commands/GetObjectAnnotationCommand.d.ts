...
declare const GetObjectAnnotationCommand_base: {
    new (input: GetObjectAnnotationCommandInput): import("@smithy/core/client").CommandImpl<GetObjectAnnotationCommandInput, GetObjectAnnotationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetObjectAnnotationCommandInput): import("@smithy/core/client").CommandImpl<GetObjectAnnotationCommandInput, GetObjectAnnotationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
