...
declare const GetObjectCommand_base: {
    new (input: GetObjectCommandInput): import("@smithy/core/client").CommandImpl<GetObjectCommandInput, GetObjectCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetObjectCommandInput): import("@smithy/core/client").CommandImpl<GetObjectCommandInput, GetObjectCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
