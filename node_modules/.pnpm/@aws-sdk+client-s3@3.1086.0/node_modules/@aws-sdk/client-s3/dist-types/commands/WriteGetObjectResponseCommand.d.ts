...
declare const WriteGetObjectResponseCommand_base: {
    new (input: WriteGetObjectResponseCommandInput): import("@smithy/core/client").CommandImpl<WriteGetObjectResponseCommandInput, WriteGetObjectResponseCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: WriteGetObjectResponseCommandInput): import("@smithy/core/client").CommandImpl<WriteGetObjectResponseCommandInput, WriteGetObjectResponseCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
