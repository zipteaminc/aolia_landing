...
declare const GetBucketReplicationCommand_base: {
    new (input: GetBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketReplicationCommandInput, GetBucketReplicationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<GetBucketReplicationCommandInput, GetBucketReplicationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
