...
declare const UploadPartCommand_base: {
    new (input: UploadPartCommandInput): import("@smithy/core/client").CommandImpl<UploadPartCommandInput, UploadPartCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UploadPartCommandInput): import("@smithy/core/client").CommandImpl<UploadPartCommandInput, UploadPartCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
