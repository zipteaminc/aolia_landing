...
declare const PutObjectAnnotationCommand_base: {
    new (input: PutObjectAnnotationCommandInput): import("@smithy/core/client").CommandImpl<PutObjectAnnotationCommandInput, PutObjectAnnotationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutObjectAnnotationCommandInput): import("@smithy/core/client").CommandImpl<PutObjectAnnotationCommandInput, PutObjectAnnotationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
