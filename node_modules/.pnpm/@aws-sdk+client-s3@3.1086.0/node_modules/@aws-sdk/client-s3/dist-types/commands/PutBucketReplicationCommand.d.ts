...
declare const PutBucketReplicationCommand_base: {
    new (input: PutBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<PutBucketReplicationCommandInput, PutBucketReplicationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutBucketReplicationCommandInput): import("@smithy/core/client").CommandImpl<PutBucketReplicationCommandInput, PutBucketReplicationCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
