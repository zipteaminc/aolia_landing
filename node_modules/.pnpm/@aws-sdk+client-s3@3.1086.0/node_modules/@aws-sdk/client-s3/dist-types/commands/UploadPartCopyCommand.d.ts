...
declare const UploadPartCopyCommand_base: {
    new (input: UploadPartCopyCommandInput): import("@smithy/core/client").CommandImpl<UploadPartCopyCommandInput, UploadPartCopyCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UploadPartCopyCommandInput): import("@smithy/core/client").CommandImpl<UploadPartCopyCommandInput, UploadPartCopyCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
