...
declare const RestoreObjectCommand_base: {
    new (input: RestoreObjectCommandInput): import("@smithy/core/client").CommandImpl<RestoreObjectCommandInput, RestoreObjectCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: RestoreObjectCommandInput): import("@smithy/core/client").CommandImpl<RestoreObjectCommandInput, RestoreObjectCommandOutput, import("..").S3ClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
